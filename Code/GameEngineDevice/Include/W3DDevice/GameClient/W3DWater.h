...
protected:
	...
	DX8IndexBufferClass			*m_waterGridIndexBuffer;	///<grid water strip indices (Vulkan/DX8)
	DX8VertexBufferClass		*m_waterGridVertexBuffer;	///<grid water vertices (Vulkan/DX8)
