...
class TextureClass : public W3DMPO, public RefCountClass
{
	...
	public:
		...
		bool Owns_Vulkan_Texture() const { return Vulkan_Texture_Owned; }
		void Set_Vulkan_Texture(void *texture, bool owned = true)
		{
			Vulkan_Texture = texture;
			Vulkan_Texture_Owned = (texture != nullptr) && owned;
		}
		/* Persistent CPU shadow for procedural Get_Surface_Level (D3D lock semantics). */
		void *Peek_Vulkan_Procedural_Surface() const { return Vulkan_Procedural_Surface; }
		void Set_Vulkan_Procedural_Surface(void *surface) { Vulkan_Procedural_Surface = surface; }
	...
	protected:
		...
		bool Vulkan_Texture_Owned = false;
		void *Vulkan_Procedural_Surface = nullptr; /* SurfaceClass* CPU shadow */
		int Width = 0;
		int Height = 0;
#endif
		bool Initialized;
