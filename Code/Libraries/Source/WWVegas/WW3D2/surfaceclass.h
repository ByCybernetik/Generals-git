...
class SurfaceClass : public RefCountClass
{
	public:
		...
		//
		static unsigned int PixelSize(const SurfaceDescription &sd);
		static void Convert_Pixel(Vector3 &rgb, const SurfaceClass::SurfaceDescription &sd, const unsigned char * pixel);
		static void Convert_Pixel(unsigned char * pixel,const SurfaceClass::SurfaceDescription &sd, const Vector3 &rgb);
