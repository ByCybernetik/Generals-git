...
public:
	...
	bool	Set_Use_Hard_Word_Wrap (bool onoff);
	void	Set_Hot_Key_Parse (bool onoff);
	bool	Set_Word_Wrap_Centered (bool onoff);
...
//	const Vector2 & Get_Cursor( void )						{ return Cursor; }
	...
	void	Build_Sentence (const WCHAR *text, void *, void *) { Build_Sentence(text); }
