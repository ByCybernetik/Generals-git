...
public:
	...
	static void _Reset_Vulkan_Frame_Slot(uint32_t slot);
#endif
...
#if defined(RENEGADE_VULKAN)
	void *Peek_Vulkan_Buffer() const { return Vulkan_Buffer; }
	void Set_Vulkan_Buffer(void *buffer) { Vulkan_Buffer = buffer; }
#endif
