...
WW3DFormat Get_Valid_Texture_Format(WW3DFormat format, bool is_compression_allowed)
{
	...
	if (!DX8Wrapper::Get_Current_Caps()->Support_DXTC() || 
		...
		case WW3D_FORMAT_DXT1:
			...
			if (!DX8Wrapper::Get_Current_Caps()->Support_Texture_Format(WW3D_FORMAT_DXT1) && DX8Wrapper::Get_Current_Caps()->Support_Texture_Format(WW3D_FORMAT_DXT2)) {
...
void Get_WW3D_Format_Name(WW3DFormat format, StringClass& name)
{
	...
	case WW3D_FORMAT_U8V8: name="U8V8"; break;
	case WW3D_FORMAT_L6V5U5: name="L6V5U5"; break;
	case WW3D_FORMAT_X8L8V8U8: name="X8L8V8U8"; break;
