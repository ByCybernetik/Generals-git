...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case ScriptAction::SET_FPS_LIMIT:
			...
			/*
			 * Maps set 20/25 for cinematic timing. On Linux that becomes logic Hz only;
			 * visual FPS stays at FramesPerSecondLimit (typically 60).
			 */
			{
				const Int mapHz = pAction->getParameter(0)->getInt();
				TheGameEngine->setMapLogicHz(mapHz);
