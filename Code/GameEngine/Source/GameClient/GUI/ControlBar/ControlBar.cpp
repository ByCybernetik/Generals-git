...
#include "GameClient/ControlBarNameTables.h"
#include "GameLogic/WeaponSlotTypeNameTables.h"
#include "GameClient/RadiusCursorNameTables.h"
...
/*
	...
	if( m_isObserverCommandBar)
	{
		...
		else // get the first and only drawable in the selection list
			drawToEvaluateFor = TheInGameUI->getFirstSelectedDrawable();
