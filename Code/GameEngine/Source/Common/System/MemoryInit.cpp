...
void userMemoryManagerGetDmaParms(Int *numSubPools, const PoolInitRec **pParms)
{
	...
	// Smaller initial blobs on Linux: faster startup, less pressure during porting.
	static const PoolInitRec defaultDMA[7] =
	{
		{ "dmaPool_16", 16,     8192, 1024 },
		{ "dmaPool_32", 32,    16384, 1024 },
		{ "dmaPool_64", 64,     8192, 1024 },
		{ "dmaPool_128", 128,   8192, 1024 },
		{ "dmaPool_256", 256,   4096, 1024 },
		{ "dmaPool_512", 512,   4096, 1024 },
		{ "dmaPool_1024", 1024, 4096, 1024 }
	};
#else
	static const PoolInitRec defaultDMA[7] = 
	{
