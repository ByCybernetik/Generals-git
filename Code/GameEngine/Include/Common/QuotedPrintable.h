...
/*
 * Preferences UserName storage. On Linux this is UTF-8 (readable Cyrillic in
 * .ini); legacy Generals UTF-16 quoted-printable is still accepted on read.
 * On Windows this matches Unicode QuotedPrintable.
 */
