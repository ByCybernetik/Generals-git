...
public:
	...
	/*
	 * Must not be inline: with AIUpdateInterface + ProjectileUpdateInterface MI,
	 * GCC needs the out-of-line return so PUI* is correctly adjusted (same issue
	 * as DumbProjectileBehavior — wrong this drops launch/guidance state).
	 */
	...
	static MissileAIUpdate* asMissileAI(BehaviorModule* mod);
